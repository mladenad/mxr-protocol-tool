...
import { CanFrame, REGISTERS, RegisterType, MXR_ID_DEFAULT, MODULE_TYPE_FIXED, DecodedFrame, MONITOR_ADDR } from './types';
    ...
    return (
        <div className="min-h-screen p-6 font-sans selection:bg-accent selection:text-white">
            <header className="mb-8 border-b border-industrial-700 pb-4">
                ...
                <p className="text-industrial-500 mt-2 text-sm">MXR100080B-DCs Charging Module CAN Interface</p>
            </header>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                ...
                                />
                                <div className="text-sm self-center text-gray-500">0x{targetAddr.toString(16).padStart(2, '0').toUpperCase()}</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                <optgroup label="Controls (Write)">
                                    {registerOptions
                                        .filter((r) => (r.type as string).includes('WRITE'))
                                        .map((r) => (
                                ...
                                <optgroup label="Read Telemetry">
                                    {registerOptions
                                        .filter((r) => (r.type as string).includes('READ'))
                                        .map((r) => (
                                            <option key={r.value} value={r.value}>
                                                {r.label}
                                            </option>
                        ...
                        <div
                            className={`transition-opacity ${(REGISTERS[parseInt(selectedRegAddr, 16)]?.type as string).includes('READ') ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}
                        >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    ...
                                    <div className="col-span-2 p-2 bg-black bg-opacity-20 rounded">
                                        ...
                                        <div className="font-mono text-xl text-green-400">
                                            {Array.from(generatedFrame.data)
                ...
                <section className="bg-industrial-800 rounded-xl border border-industrial-700 p-6 shadow-xl">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            />
                            <button onClick={handleDecode} className="w-full bg-industrial-700 hover:bg-industrial-600 text-white font-semibold py-2 rounded transition-colors">
                                Decode Frame
                            </button>
                        </div>
                            ...
                            <div className="bg-industrial-900 rounded-lg p-4 border border-industrial-700 animate-fade-in">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="font-mono text-accent">0x{decodedResult.register.toString(16).padStart(4, '0').toUpperCase()}</span>
                                    ...
                                    <div>
                                        ...
                                        <span className="font-mono text-lg text-white font-bold">
                                            ...
                                            <span className="text-xs text-gray-500 ml-1 font-normal">{REGISTERS[decodedResult.register]?.unit}</span>
                                        </span>
                                    </div>
                                </div>

                                {decodedResult.isError && <div className="p-2 bg-red-900/20 border border-red-900/50 rounded text-red-400 text-xs">{decodedResult.errorDescription}</div>}
                            </div>
                        )}
                    </div>
                </section>
